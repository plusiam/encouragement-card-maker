...
### v1.2.0 (2026-03-31)
- ✅ **보안 강화** - printCard() XSS 취약점 수정, HTML 이스케이프 적용
- ✅ **성능 최적화** - Canvas 렌더링 debounce(300ms), 폰트 로딩 비차단 방식 전환
- ✅ **안정성 개선** - localStorage 데이터 검증 강화, 팝업 차단 대응
- ✅ **접근성 향상** - 별빛 템플릿 색상 대비 개선, 인쇄 CSS 최적화
- ✅ **반응형 UX** - 태블릿 브레이크포인트(768px, 600px) 추가, 터치 피드백
- ✅ **사용자 피드백** - 토스트 알림 시스템 (문구 추가/삭제/저장 시 안내)
...
- [ ] 교실 활동 코드 시스템 (학급 단위 활동)
- [ ] PDF 북릿 내보내기 (학급 카드 모음집)
- [ ] 소셜 기능 (친구에게 카드 보내기)
